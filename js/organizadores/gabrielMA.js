...
export const gabrielMA = new Organizador(
  2,
  "Gabriel Méndez",
  "gabrielMA1.jpg",
  `
  ...
  <ul>
    <li>Primer lugar en el concurso Presea al Mérito y beca del Conservatorio de Música del Estado de México.</li>
    <li>Primer lugar en el Concurso Nacional de Intérpretes de Guitarra de Paracho en la categoría avanzados.</li>
    <li>Primer lugar absoluto en el concurso del Istituto di Alta Formazione Musicale Luigi Boccherini en Lucca, Italia, con lo cual obtuvo una beca para realizar sus estudios en dicha institución.</li>
