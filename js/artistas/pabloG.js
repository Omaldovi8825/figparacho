...
export const pabloG = new Evento(
  4,
  "pabloG1.jpg",
  "Pablo Garibay",
  "México",
  ...
  <p>Recientemente estrenó en México la Cantata de Perugia para guitarra, coro y orquesta, dirigida por Leo Brouwer, su autor. Asimismo, fue solista de la Dortmunder  Philharmoniker de Alemania dirigido por Gabriel Feltz, y en la sala Tchaikovsky en Moscú en dos ocasiones, con la Svetlanov Symphony interpretando el Concierto de Aranjuez y el Concierto del Sur de Manuel M. Ponce. Pablo Garibay estrenó esta misma obra en Sudáfrica, y ofreció el estreno mundial de Zimmergramm, obra comisionada al compositor mexicano Enrico Chapela por la Deutsche Welle, en el Beethovenfest de Bonn (Alemania). También realizó la primera audición mundial de El árbol de la vida de Hebert Vázquez con la Filarmónica de la Ciudad de México, y del mismo autor, Interregno, junto con el ensamble NOMAD y Norio Sato y de partituras de Tomás Barreiro, Mateo Barreiro, Diógenes Rivas y muchos más.</p>
  <p>El gentil sonido de su guitarra ha sonado en foros tan célebres como la Sala Nezahualcóyotl de la ciudad de México, y en el extranjero en la Sala Tchaikovsky de Moscú, Teatro Nacional de Belgrado, Parco della Música en Roma, Beethovenhalle de Bonn, Philharmonie de Hannover, Tokio Opera City Recital Hall en Japón y Meraner Musikfestival en Italia. Recientemente realizó como productor e intérprete la producción para URTEXT de Sound Dreams, disco con música de Hebert Vázquez junto con el ensamble NOMAD en el Tokio Opera City Recital Hall en Japón. Para NAXOS participó en la primera grabación mundial de “El árbol de la vida” dentro del Disco Compacto con el mismo título, junto a la OJUEM, dirigida por Gustavo Rivero Weber</p>
  <p>Otras de sus grabaciones han sido publicadas por los sellos Naxos, Urtext, RTV de España y Fleur de Son Classics de Estados Unidos. Fue becario del Programa de Creadores Escénicos con Trayectoria del FONCA, promoviendo las obras de autores mexicanos como Hebert Vázquez, Rodrigo Sigal, Tomás Barreiro, y María Granillo, por nombrar unos cuantos.</p>
  `,
  "estelar"
)
